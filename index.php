...
<h4 class="mb-2"><strong>STAR✘ STRIPE CHECKER</strong></h4>
  ...
  <div class="content-body">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body text-center">
					...
					<input type="text" style="background-color:#112132;" class="form-control" id="cslive" placeholder="CS LIVE" name="cslive">&nbsp;       
					<input type="text" style="background-color:#112132;" class="form-control" id="pklive" placeholder="PK LIVE" name="pklive">
                    </div>
		...
		<div class="col-xl-12">
		 ...
		 <div class="text-center" style="color:#545452;">
            STAR✘
modified by : @SaaimStar
	</div>
...
Swal.fire({ title: "@AndTricksBD", text: "@SaaimStar", icon: "warning", confirmButtonText: "Join", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
...
Swal.fire({title: 'wait for the card to be processed, bro!', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
